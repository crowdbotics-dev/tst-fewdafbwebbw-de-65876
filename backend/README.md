...
## Project Structure
    ...
    ├── tst_fewdafbwebbw_de_65876  # Django project configurations
...
1. Clone this repo and `cd tst_fewdafbwebbw_de_65876`
...
2. Clone this repo and `cd tst_fewdafbwebbw_de_65876`
